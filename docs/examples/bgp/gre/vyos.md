...
:::warning
トンネル境界アドレス(上記例示では192.0.2.254/31, 2001:db8:2::/64)では、インターネットへの通信はできません。  
...
ping等で疎通確認する場合には、当団体から割り当てたIPアドレス(上記例示の場合、192.0.2.6, 2001:db8:1::fffe)をソースアドレスとして指定してください。
:::
